...
namespace Royal_Rent_System
{
    public partial class Rent : Form
    {
        ...
        private void btnbill_Click(object sender, EventArgs e)
        {
            ...
            txtmod.Text = (cash - amount).ToString(); */


            txtResult.Text += "****************************************************************\n";
            txtResult.Text += "*****************  ROYAL CAR RENT *********************\n";
            txtResult.Text += "****************************************************************\n";
            txtResult.Text += "Date:" + DateTime.Now + "\n\n";
            txtResult.Text += "\n";

            txtResult.Text += "Id: " + txtId.Text + "\n\n";
            txtResult.Text += "Car Reg No: " + CarRegCb.Text + "\n\n";
            txtResult.Text += "Customer Nic: " + CustCb.Text + "\n\n";
            txtResult.Text += "Name: " + txtName.Text + "\n\n";
            txtResult.Text += "Rent Date: " + Dtp1.Text + "\n\n";
            txtResult.Text += "Return Date: " + Dtp2.Text + "\n\n";
            txtResult.Text += "Passenger: " + comboBox1.Text + "\n\n\n";
            txtResult.Text += "Distance: " + txtDistance.Text + "\n\n\n";
            txtResult.Text += "Price: " + txtPrice.Text + "\n\n\n";


            txtResult.Text += "****************************************************************\n";
            txtResult.Text += "**********************  THANK YOU  ***********************\n";
            txtResult.Text += "****************************************************************\n";
        }
